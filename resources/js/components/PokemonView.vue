        ...
        <div class="card-body card-content">
          ...
          <div class="icons">
            <font-awesome-icon
              ...
              icon="thumbs-up"
              @click="pokemonHatedLiked('liked')"
            />
            <font-awesome-icon
              class="thumbs-up hate-icon hated"
              icon="thumbs-down"
              @click="pokemonHatedLiked('hated')"
            />
          </div>
...
export default {
  ...
  methods: {
    ...
    pokemonHatedLiked(status) {
      this.newPokemon.id = this.thisPokemon.id;
      this.newPokemon.name = this.thisPokemon.name;
      this.newPokemon.user_id = this.userLogged.id;
      this.newPokemon.status = status;

      axios
        .post("api/pokemons/pokemon-hated-liked", {"pokemon":this.newPokemon})
        .then((response) => {
